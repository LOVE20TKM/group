...
- 生态集成：为 LOVE20 生态中的协议提供统一的身份系统，
- 权益转让：通过 NFT 转让实现链上经营权、收益权、身份等生态权益的流转
- 价值发现：稀缺和有意义的名称具有增值潜力，有更高的市场价值
...
持有 NFT 的地址，可声明一个默认NFT，用于地址的身份展示与默认上下文；该关联不影响 NFT 所有权。NFT转走后，将自动不再视为原地址的默认NFT。

详细规则请参考 [地址关联规则](./docs/地址关联规则.md)
